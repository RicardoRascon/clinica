...
.modal1 > .modal-dialog {
                                        ...
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                <div class="text-center">
                                                    <h1 class="h4 text-gray-900 mb-4">Busqueda de Usuarios</h1>
                                                    <form class="user" method="post" id="form_buscar" name="form_buscar">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <a><input type="button" name="boton_usuario" value="Agregar Usuario" class="btn btn-primary" onClick="window.location = '../contenidos/registroUsuarios.php'"></a>
                                                            </div>
   ...
   var str = "";
    $.ajax({
        type: "POST",
        url: "usuarios/edit_usuarios.php",
        data: "id="+ id,
        cache: false,
        async: true,
        success: function(response){
                ...
                buttons: {
                  ...
                  success: {
                    ...
                    callback: function() {
                      $.ajax({
                        type: "POST",
                        url: "usuarios/forma_update_usuarios.php",
