    ...
    <body id="page-top">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                <div class="text-center">
                                                    <h1 class="h4 text-gray-900 mb-4">Inventario de Productos</h1>
                                                    <form class="user" method="post" id="form_buscar" name="form_buscar">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control " id="producto" name="producto" placeholder="Ingresa el Nombre del Producto" >
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <a><input type="button" name="boton_buscar" value="Buscar" class="btn btn-success" onclick="Buscar()"></a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <a><input type="button" name="boton_usuario" value="Agregar Producto" class="btn btn-primary" onClick="window.location = '../contenidos/registroProductos.php'"></a>
                                                            </div>
        ...
        <script>
            function Buscar(){
                ...
                $.ajax({
                    type: "POST",
                    url: "inventario/productos_code.php",
             ...
             function change_status(id,nom,val){
                ...
                $.ajax({
                    type: "POST",
                    url: "usuarios/Change_Status.php",
                ...
                buttons: {
                  ...
                  success: {
                    ...
                    callback: function() {
                       ...
                       if (confirm('Seguro desea Realizar esta Operacion?')) {


                      $.ajax({
                        type: "POST",
                        url: "inventario/forma_update_inv.php",
                        data: $("#forma_update_inv").serialize(),
                        cache: false,
                        async: true,
                        success: function(response){
                            var str = response;
