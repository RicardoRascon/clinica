                                        ...
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                <div class="text-center">
                                                    <h1>Agenda</h1><br>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <input type="text" name="paciente" id="paciente" placeholder="Nombre del Paciente" class="form-control form-control-user" >
                                                    ...
                                                    <div class="col-sm-1">
                                                                <a><input type="button" name="boton_buscar" value="Buscar" class="btn btn-success btn-user btn-block" onclick="Buscar()"></a>
                                                            </div>
                                                        <div class="form-group row">
       ...
       Buscar();    
            ...
            function Buscar(){
              ...
              var status= document.getElementById('status').value;
                ...
                $.ajax({
                    type: "POST",
                    url: "../clases/rep_pacientes_code.php",
                      data: "paciente="+ paciente + "&fechaI=" + fechaI + "&fechaF=" + fechaF + "&consulta=" + consulta + "&status=" + status,
                    cache: false,
                    async: true,
